...
qqwidget::qqwidget(QWidget *parent,qint8 window_width,qint8 window_height)
    : QWidget(parent)
{
    setFixedSize(502,226); //hardwired?
...
void qqwidget::paintEvent(QPaintEvent *event){
 ...
 QTime nowtime = QTime::currentTime();
    ...
    increase=increase/(increase_log[numScalefft]-increase_log[1]);  //now normalized to display section
    QPainter painter;
    painter.begin(this);
